...
export default function AuditLogsPage() {
  const logs = [
    ...
    { id: 4, action: "استرداد مبلغ", details: "تمت الموافقة على استرداد مبلغ 150 ر.ي للطلب (ORD-105)", user: "حسان الإداري", ip: "192.168.1.15", date: "22 يونيو 2026, 16:45", type: "action" },
