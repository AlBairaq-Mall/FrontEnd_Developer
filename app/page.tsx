...
export default function LandingPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 flex flex-col text-right selection:bg-brand selection:text-white" dir="rtl" id="home">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#home" className="text-sm font-medium text-white hover:text-brand transition-colors relative group py-2">
              الرئيسية
              <span className="absolute bottom-0 right-0 w-0 h-0.5 bg-brand transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#about" className="text-sm font-medium text-gray-300 hover:text-brand transition-colors relative group py-2">
              من نحن
              <span className="absolute bottom-0 right-0 w-0 h-0.5 bg-brand transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#services" className="text-sm font-medium text-gray-300 hover:text-brand transition-colors relative group py-2">
              خدماتنا
              <span className="absolute bottom-0 right-0 w-0 h-0.5 bg-brand transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="#contact" className="text-sm font-medium text-gray-300 hover:text-brand transition-colors relative group py-2">
              تواصل معنا
              <span className="absolute bottom-0 right-0 w-0 h-0.5 bg-brand transition-all duration-300 group-hover:w-full"></span>
            </a>
          </nav>
      ...
      <section className="relative min-h-[90vh] lg:min-h-screen flex items-center justify-center bg-[#111111] overflow-hidden pt-28 pb-16 lg:py-0">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#111111] via-[#111111]/80 to-[#111111]/60"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            {/* Left Column: Device Mockups & Brand Bag */}
            <div className="lg:col-span-5 flex items-center justify-center relative">
              <div
                className="relative w-full max-w-[500px] lg:max-w-none transition-transform duration-500 hover:scale-[1.02]"
                style={{ animation: "float 6s ease-in-out infinite" }}
              >
                <Image
                  src="/hero_mockup.jpg"
                  alt="تطبيق البيرق ماركت"
                  width={650}
                  height={500}
                  className="object-contain drop-shadow-[0_20px_50px_rgba(223,159,0,0.15)] rounded-2xl"
                  priority
                />
              </div>
            </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 hidden sm:block">
          <a
            href="#about"
            className="w-10 h-10 rounded-full border border-white/20 bg-white/5 hover:border-brand/60 hover:bg-brand/10 flex items-center justify-center text-white hover:text-brand transition-all duration-300"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 flex flex-col justify-between hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 min-h-[500px]" id="contact">
              <div>
                ...
                <div className="space-y-5">
                  <a href="tel:+967777123456" className="flex items-center gap-4 group">
                    ...
                    <div className="text-right">
                      <span className="block text-xs text-gray-400">رقم الهاتف</span>
                      <span className="text-sm font-bold text-gray-800 direction-ltr inline-block hover:underline">+967 777 123 456</span>
                    </div>
                  </a>

                  <a href="mailto:info@al-bairaq.com" className="flex items-center gap-4 group">
                    <div className="w-10 h-10 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center text-gray-500 group-hover:bg-brand/10 group-hover:text-brand transition-colors">
                      <Mail className="w-4 h-4" />
                    </div>
                    <div className="text-right">
                      <span className="block text-xs text-gray-400">البريد الإلكتروني</span>
                      <span className="text-sm font-bold text-gray-800 hover:underline">info@al-bairaq.com</span>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-right">
                      <span className="block text-xs text-gray-400">العنوان الرئيسي</span>
                      <span className="text-sm font-bold text-gray-800">اليمن - حضرموت - تريم</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-50">
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-brand/10 hover:bg-brand hover:text-white text-brand font-bold text-sm transition-all duration-300 shadow-sm"
                >
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 flex flex-col justify-between hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 min-h-[500px]">
              ...
              <div className="mt-8 pt-6 border-t border-gray-50">
                <a
                  href="#services"
                  className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-gray-900 hover:bg-gray-800 text-white font-bold text-sm transition-all duration-300 shadow-sm"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-12">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="flex items-center gap-3.5 pt-2">
                ...
                <a href="https://wa.me/967777123456" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 hover:bg-brand/20 hover:text-brand flex items-center justify-center text-gray-400 transition-colors" aria-label="WhatsApp">
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#home" className="text-gray-400 hover:text-brand transition-colors">الأقسام</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-brand transition-colors">العروض</a></li>
                <li><a href="#home" className="text-gray-400 hover:text-brand transition-colors">المنتجات الجديدة</a></li>
                <li><a href="#contact" className="text-gray-400 hover:text-brand transition-colors">الأسئلة الشائعة</a></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#services" className="text-gray-400 hover:text-brand transition-colors">التوصيل والشحن</a></li>
                <li><a href="#about" className="text-gray-400 hover:text-brand transition-colors">الاسترجاع والاستبدال</a></li>
      ...
      {/* 5. Floating WhatsApp help widget */}
